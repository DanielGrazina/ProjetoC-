namespace daniel_grazina_3935
{
    ...
    "_________________________________________";
			...
			// tpGestao
			// 
			this.tpGestao.Controls.Add(this.cbNivel);
			this.tpGestao.Controls.Add(this.txtPassword);
			this.tpGestao.Controls.Add(this.lblPass);
			this.tpGestao.Controls.Add(this.lblNivel);
			this.tpGestao.Controls.Add(this.txtUserName);
			this.tpGestao.Controls.Add(this.txtId);
			this.tpGestao.Controls.Add(this.lblUserName);
			this.tpGestao.Controls.Add(this.lblId);
			this.tpGestao.Controls.Add(this.btnEliminarUser);
			this.tpGestao.Controls.Add(this.btnAtualizarUser);
			this.tpGestao.Controls.Add(this.btnInserirUser);
			this.tpGestao.Controls.Add(this.btnVerLista);
			this.tpGestao.Controls.Add(this.label1);
			this.tpGestao.Controls.Add(this.gridView);
			...
			this.label1.Text = "Listagem de utilizadores";
			// 
			// gridView
			// 
			this.gridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.gridView.Location = new System.Drawing.Point(6, 178);
			this.gridView.Name = "gridView";
			this.gridView.Size = new System.Drawing.Size(672, 232);
